...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'MobileappBackend', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'backend', 'password' => 'backend', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_50c2c9cf5b5ecd731df259f55a9f750f');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_50c2c9cf5b5ecd731df259f55a9f750f');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_50c2c9cf5b5ecd731df259f55a9f750f');
        ...
        $f->setProxyDir('D:/Projects/MobileApp.Backend/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getFosRest_SerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('D:/Projects/MobileApp.Backend/app/cache/prod/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/Projects/MobileApp.Backend/app/logs/prod.log', 100, true);
    }
    protected function getMonolog_Handler_WsseService()
    {
        return $this->services['monolog.handler.wsse'] = new \Monolog\Handler\StreamHandler('D:/Projects/MobileApp.Backend/app/logs/prod.wsse.log', 400, true);
    }
    ...
    {
        return $this->services['security.authentication.provider.wsse.wsse_secured'] = new \PGZN\MobileAppBackendBundle\Security\Authentication\Provider\WsseProvider($this->get('fos_user.user_manager'), 'D:/Projects/MobileApp.Backend/app/cache/prod/security/nonces');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_WsseSecuredService()
    {
        ...
        return $this->services['security.firewall.map.context.wsse_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.authentication.listener.wsse.wsse_secured'), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '51cd69b346708', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'wsse_secured', NULL, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Projects/MobileApp.Backend/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/Projects/MobileApp.Backend/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Projects/MobileApp.Backend/app/cache/prod/sessions');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Projects/MobileApp.Backend/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['wsse.security.authentication.provider'] = new \PGZN\MobileAppBackendBundle\Security\Authentication\Provider\WsseProvider('', 'D:/Projects/MobileApp.Backend/app/cache/prod/security/nonces');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Projects/MobileApp.Backend/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Projects/MobileApp.Backend/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Projects/MobileApp.Backend/app/cache/prod',
            ...
            'session.save_path' => 'D:/Projects/MobileApp.Backend/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/Projects/MobileApp.Backend/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Projects/MobileApp.Backend/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'D:/Projects/MobileApp.Backend/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/Projects/MobileApp.Backend/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Projects/MobileApp.Backend/app/cache/prod/doctrine/orm/Proxies',
            ...
            'fos_rest.cache_dir' => 'D:/Projects/MobileApp.Backend/app/cache/prod/fos_rest',
